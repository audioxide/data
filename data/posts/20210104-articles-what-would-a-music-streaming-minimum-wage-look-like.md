...
- **Explore ethical alternatives to Spotify et al.** With their pay per play approaches it literally costs pennies to try them out. For those unsure where to start [we list a handful of services in this article](/articles/artist-friendly-alternatives-to-spotify/).
